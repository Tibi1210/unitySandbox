...
public class Waves1 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        computeShader.GetKernelThreadGroupSizes(kernel, out BLOCK_DIM, out _, out _);
        GRID_DIM = (int)((resN + (BLOCK_DIM - 1)) / BLOCK_DIM);
        
        Debug.Log("N: " + resN);
        Debug.Log("Block Dim: " + BLOCK_DIM);
        Debug.Log("Grid Dim: " + GRID_DIM);
        ...
        objMaterial.SetFloat("_SpecularNormalStrength", specularNormalStrength);
    }
